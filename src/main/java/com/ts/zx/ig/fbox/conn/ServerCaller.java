        ...
        for (; ; ) {
            ...
            try {
                ...
                if (statusCode == 401) {
                    ...
                    int errCode = Integer.parseInt(response.getFirstHeader("X-FBox-Code").getValue());
                    throw new BoxServerResponseException(statusCode, statusLine.getReasonPhrase(), errCode);
                }
                ...
                if (body != null) {
                    ...
                    try {
                        ...
                        if (tClass.isAssignableFrom(String.class))
                            ...
                            throw new IllegalArgumentException("Response cannot be parsed to " + tClass.toString() + " contentType is " + body.getContentType());
                    }
                }
