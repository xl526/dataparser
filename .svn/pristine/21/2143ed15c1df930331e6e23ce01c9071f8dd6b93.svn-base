...
class NetworkRunnable implements Runnable {
     ...
     */
    public NetworkRunnable(Logger logger, Request request, HttpConnectionFuture future, ResponseCallback callback, Proxy proxy) {
        mLogger = logger;
        mRequest = request;
        mFuture = future;
        mCallback = callback;
     ...
     */
    HttpURLConnection createHttpURLConnection(Request request) throws IOException {
